...
final List<List<Color>> gradientcolors = [
  [
    "#42E695".fromHexToColor(),
    "#3BB2B8".fromHexToColor(),
  ],
  [
    "#654EFE".fromHexToColor(),
    "#8738E9".fromHexToColor(),
  ],
  [
    "#F0D57C".fromHexToColor(),
    "#F48742".fromHexToColor(),
  ],
  [
    "#F568D8".fromHexToColor(),
    "#8838E7".fromHexToColor(),
  ],
  [
    "#FF6A9E".fromHexToColor(),
    "#FE5762".fromHexToColor(),
  ]
];

final List<Color> overallcolor = gradientcolors[0];
final List<Color> cabcolor = gradientcolors[2];
final List<Color> foodcolor = gradientcolors[1];
final List<Color> signingscolor = gradientcolors[3];
final List<Color> extrascolor = gradientcolors[4];
